// data/pricing.ts
// Kent driveway gate pricing data (2026 market rates)
...
export const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    description: 'Covers gate fabrication or supply, post foundations, underground or ram-arm motors, two remote handsets, and BS EN 12453 compliant safety sensors. Underground motors and bespoke wrought iron designs sit toward the top of the range. The most widely installed gate type across Kent.',
  },
  {
  ...
  },
  {
    ...
    description: 'Covers diagnostic callouts, motor and control board repair or replacement, hinge realignment, safety sensor recalibration, intercom faults, and remote reprogramming. Annual service packages covering all mechanical and electronic elements available from most Kent engineers in our network.',
  },
];
...
export const financeInfo = {
  ...
  description: 'Most Kent installers in our network offer 0% interest finance on gate installations. Spread the cost of your project over 6 to 36 months from as little as £99 per month, with nothing to pay upfront at many providers. Subject to status and approval.',
};
