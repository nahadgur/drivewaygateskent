      ...
      <div className="bg-brand-900 text-brand-50 py-2 px-4 text-sm hidden md:block">
        <div className="container-width flex justify-between items-center">
          <span className="flex items-center gap-2">
            <MapPin className="w-4 h-4" /> Vetted Driveway Gate Installers Across Kent
          </span>
        </div>
      </div>
        ...
        <div className="container-width">
          <div className="flex justify-between items-center h-20">
            ...
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <img src="/logo.png" alt="Driveway Gates Kent" className="h-10 w-auto" />
              <div className="flex flex-col">
                <span className="font-display font-bold text-xl leading-none text-gray-900">Driveway Gates</span>
                <span className="text-xs text-brand-500 font-semibold tracking-widest uppercase">Kent</span>
              </div>
            </Link>
