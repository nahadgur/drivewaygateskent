            ...
            <div className="lg:col-span-2">
              ...
              <section className="mb-12">
                ...
                <div className="prose prose-gray max-w-none text-gray-600 space-y-4">
                  <p>
                    Kent has a more complex gate market than most counties. The North Downs and Kent Hills create sloped driveways that require specific motor and hinge engineering. The AONB and the county's dense network of conservation areas add a planning dimension that many installers are not equipped to handle. The premium North Kent market around Weybridge, Cobham, and Esher sets expectations around wrought iron, underground motors, and video access management that general builders cannot meet. Every installer we refer in {cityName} specialises in residential gates, carries full public liability insurance, and has the project history to back their experience up.
                  </p>
                  <p>
